...
function getMatchedPreset(sName) {
  if (!sName) return {};
...
// Test cases
console.log("Match '19/5' =>", getMatchedPreset("19/5").schoolNameCustom, getMatchedPreset("19/5").contractNo);
console.log("Match 'Trường MN 19-5' =>", getMatchedPreset("Trường MN 19-5").schoolNameCustom);
console.log("Match 'Bàn Tay Vàng' =>", getMatchedPreset("Bàn Tay Vàng").schoolNameCustom);
console.log("Match 'Vịt Con' =>", getMatchedPreset("Vịt Con").schoolNameCustom);
